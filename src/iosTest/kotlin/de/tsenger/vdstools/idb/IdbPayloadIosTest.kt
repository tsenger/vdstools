...
class IdbPayloadIosTest {
    ...
    fun testConstructorWithoutSignature() {
        ...
        val messageGroup = IdbMessageGroup(
            listOf(IdbMessage.fromNameAndContent("PROOF_OF_RECOVERY", "b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray()))
        )
    ...
    fun testConstructorWithoutCertificate() {
        ...
        val messageGroup = IdbMessageGroup(
            listOf(
                IdbMessage.fromNameAndContent("PROOF_OF_VACCINATION", "b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray())
            )
        )
    ...
    fun testGetEncodedWithoutCertificate() {
        ...
        val messageGroup = IdbMessageGroup(
            listOf(IdbMessage.fromNameAndContent("PROOF_OF_VACCINATION", "b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray()))
        )
        val signature = IdbSignature(
            "24bbbb332f562a94f487db623b8db55c4a65b9cf532a959843a6a34e117f56343a94d5e187f28262943d84579af46d44804cf6328fa523c7".hexToByteArray()
        )

...
class IdbPayloadIosTest {
    ...
    fun testConstructorWithoutCertificate() {
        ...
        val messageGroup = IdbMessageGroup(
            IdbMessage(
                IdbMessageType.PROOF_OF_VACCINATION,
                "b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray()
            )
        )
    ...
    fun testGetIdbHeader() {
        ...
        assertContentEquals("6abc010504030201009b5d88".hexToByteArray(), header.encoded)
    }
    ...
    fun testGetIdbMessageGroup() {
        ...
        assertContentEquals(
            "61120410b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray(),
    ...
    fun testGetEncodedWithoutSignature() {
        ...
        assertContentEquals("6abc61120510b0b1b2b3b4b5b6b7b8b9babbbcbdbebf".hexToByteArray(), encodedBytes)
    }

...
class DataEncoderIosTest {
    ...
    fun testEncodeDateTime1() {
        ...
        assertContentEquals("02f527bf25b2".hexToByteArray(), dateTimeBytes)
    }
    ...
    fun testEncodeDateTime2() {
        ...
        val dateTimeBytes = DataEncoder.encodeDateTime(dateTime)
        assertContentEquals("0aecc4c7fb80".hexToByteArray(), dateTimeBytes)
    }
    ...
    fun testEncodeDateTime3() {
        ...
        val dateTimeBytes = DataEncoder.encodeDateTime(dateTime)
        assertContentEquals("00eb28c03640".hexToByteArray(), dateTimeBytes)
    }
    ...
    fun testEncodeDateTime4() {
        ...
        val dateTimeBytes = DataEncoder.encodeDateTime(dateTime)
        assertContentEquals("0b34792d9777".hexToByteArray(), dateTimeBytes)
    }
    ...
    fun testEncodeDate_String() {
        ...
        assertContentEquals("8d7ad8".hexToByteArray(), encodedDate)
    }

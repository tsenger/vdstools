...
class MessageCommonTest {
    ...
    fun testMessage_BYTE_value() {
        ...
        val message = Message(0x7F, "MESSAGE1", MessageCoding.BYTE, MessageValue.fromBytes(bytes, MessageCoding.BYTE))
    ...
    fun testMessage_C40_value() {
        ...
        val message = Message(0x02, "MESSAGE2", MessageCoding.C40, MessageValue.fromBytes(bytes, MessageCoding.C40))
    ...
    fun testMessage_BYTES_valueStr() {
        ...
        val message = Message(0x04, "MESSAGE4", MessageCoding.BYTES, MessageValue.fromBytes(bytes, MessageCoding.BYTES))
    ...
    fun testMessage_BYTE_valueStr() {
        val bytes = byteArrayOf(Byte.MAX_VALUE)
        val message = Message(0x05, "MESSAGE5", MessageCoding.BYTE, MessageValue.fromBytes(bytes, MessageCoding.BYTE))
        assertEquals("127", message.value.toString())
    }
    ...
    fun testMessage_BYTES_rawBytes() {
        val bytes = "BADC0FFE".hexToByteArray()
        val message = Message(0x06, "MESSAGE6", MessageCoding.BYTES, MessageValue.fromBytes(bytes, MessageCoding.BYTES))
    ...
    fun testMessage_UNKNOWN_rawBytes() {
        val bytes = "BADC0FFE".hexToByteArray()
        val message =
            Message(0x06, "MESSAGE6", MessageCoding.UNKNOWN, MessageValue.fromBytes(bytes, MessageCoding.UNKNOWN))
        assertContentEquals("BADC0FFE".hexToByteArray(), message.value.rawBytes)
    }

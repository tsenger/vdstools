...
import de.tsenger.vdstools_mp.vds.VdsRawBytesCommon
...
class DataParserCommonTest {
    ...
    fun testDecodeMaskedDate6_invalidFormat() {
        assertFailsWith<IllegalArgumentException> { decodeMaskedDate("ff0000".hexToByteArray()) }
    ...
    fun testDecodeHeader() {
        val bb = Buffer().write(VdsRawBytesCommon.residentPermit)

...
object VdsRawBytes {
    ...
    var addressStickerId: ByteArray = Hex.decode(
    ("""
    ...
    var socialInsurance: ByteArray = Hex.decode(
    ("""
    ...
    var arrivalAttestationV02: ByteArray = Hex.decode(
    ("""
    ...
    @JvmField
    var arrivalAttestation: ByteArray = Hex.decode(
    ...
    @JvmField
    var visa_224bitSig: ByteArray = Hex.decode(
    ("""
    ...
    var supplementSheet: ByteArray = Hex.decode(
    ("""
    ...
    var addressStickerPassport: ByteArray = Hex.decode(
    ("""
            DC03D9C5D9CAC8A73A990F71347D4E37
    ...
    var emergenyTravelDoc: ByteArray = Hex.decode(
    ("""
            DC03D9C5D9CAC8A73A990F71347D4E37
    ...
    var tempPassport: ByteArray = Hex.decode(
    ("""
    ...
    var tempPerso: ByteArray = Hex.decode(
    ("""
            dc03d9c5d9cac8a73a99a807b88bcd28
    ...
    var fictionCert: ByteArray = Hex.decode(
    ("""
    ...
    var permanentResidencePermit: ByteArray = Hex.decode(

...
""".trimIndent()
        ...
        println("✅ Generated ResourceConstants.kt with ${sealCodings.length + idbMessageTypes.length + idbDocumentTypes.length + extendedMessageDefinitions.length + fr2ddocFieldDefinitions.length} bytes")
    }
}
